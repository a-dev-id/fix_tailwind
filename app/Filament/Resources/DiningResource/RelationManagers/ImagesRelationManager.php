...
namespace App\Filament\Resources\DiningResource\RelationManagers;
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\FileUpload::make('image')->image()->directory('images/dinings/images')->hiddenLabel(),
