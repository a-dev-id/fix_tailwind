...
namespace App\Filament\Resources\HoneymoonResource\RelationManagers;
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\FileUpload::make('image')->image()->directory('images/honeymoon/images')->hiddenLabel(),
