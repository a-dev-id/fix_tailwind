...
<main>
    ...
    <section class="dual-perspectives my-32">
        <div class="flex justify-center">
            <div class="dp-left" data-aos="fade-up" data-aos-delay="200">
                ...
                <img class="lazy w-full h-[770px] wide:h-[770px] large:h-[600px] object-cover" src="{{asset('images/placeholder/vertical.webp')}}" data-src="{{asset('storage/'.$lounge_bar->hero_image)}}" alt="Card Image">
            </div>
            <div class="dp-right" data-aos="fade-up" data-aos-delay="400">
                <img class="lazy dp-l-image" src="{{asset('images/placeholder/vertical.webp')}}" data-src="{{asset('storage/'.$lounge_bar->cover_image)}}" alt="Card Image">
                <div>
                    <h3 class="sub-title2">{{$lounge_bar->title}}</h3>
                    <div class="paragraph">
                        {!!$lounge_bar->description!!}
                    </div>
    ...
    <section class="visual-harmony">
        <div class="vh-background" style="background-image: url({{asset('storage/'.$top_floor->hero_image)}})"></div>
        <div class="vh-section" data-aos="fade-up" data-aos-delay="300">
            <div class="vh-inner-section">
                <div class="vh-text">
                    <h2 class="sub-title">{{$top_floor->title}}</h2>
                    <div class="line"></div>
                    <div class="paragraph">
                        {!!$top_floor->description!!}
                    </div>
                    {{-- <a href="" class="main-button">Discover Culinary Delights</a> --}}
                </div>
                <img class="lazy vh-image" src="{{asset('images/placeholder/horizontal.webp')}}" data-src="{{asset('storage/'.$top_floor->cover_image)}}" alt="Placeholder Image">
            </div>
        </div>
    </section>
