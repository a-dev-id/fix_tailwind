...
<main>
    ...
    <section class="grid grid-cols-3 w-1/2 mx-auto">
        <div>
            <a href="tel:+62361982700" class="text-gray-600 font-arial flex flex-col justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-14 h-14 fill-gray-600">
        ...
        <div class="flex flex-col justify-center items-center">
            ...
            <span class="text-gray-600 font-arial">Desa Buahan, Payangan, Bali 80571, Indonesia</span>
        </div>
        <div>
            <a href="mailto:reservations@hanginggardensofbali.com" class="text-gray-600 font-arial flex flex-col justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-14 h-14 fill-gray-600">
                    <path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z" />
                    <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
                </svg>
                reservations@hanginggardensofbali.com
            </a>
        </div>
    </section>

    <section class="mx-auto w-1/2 text-center mt-10">
        <a href="http://wa.me/628113800988" class="flex items-center justify-center bg-green-950 hover:bg-green-900 mx-auto w-36">
            ...
            <span class="p-2 ms-2 bg-green-900">
